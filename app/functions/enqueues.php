...
add_action( 'wp_enqueue_scripts', function () use ($config) {
    ...
    register_assets('script', [
        'handle'    => 'pandoramarketing/js/sliders-impact',
        'src'       => $config['resources']['script_sliders_impact'],
        'deps'      => [ ],
        'ver'       => file_version('0.0.1'),
        'in_footer' => true
    ]);
    ...
    register_assets('script', [
        'handle'    => 'pandoramarketing/js/twitter-wjs',
        'src'       => $config['resources']['script_twitter_wjs'],
        'deps'      => [ ],
        'ver'       => file_version('0.0.1'),
        'in_footer' => true
    ]);
